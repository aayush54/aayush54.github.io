...
`,I=o.iv`
  display: inline-block;
  white-space: pre;
`,M=t=>{const{cascade:e=!1,damping:r=.5,delay:i=0,duration:a=1e3,fraction:s=0,keyframes:c=C,triggerOnce:l=!1,css:u,className:f,style:p,childClassName:d,childStyle:h,children:b,onVisibilityChange:g}=t,x=(0,n.useMemo)((()=>function({duration:t=1e3,delay:e=0,timingFunction:r="ease",keyframes:n=C,iterationCount:i=1}){return o.iv`
  ...
  `}({keyframes:c,duration:a})),[a,c]);return void 0==b?null:"string"===typeof(T=b)||"number"===typeof T||"boolean"===typeof T?w(z,{...t,animationStyles:x,children:String(b)}):(0,y.isFragment)(b)?w(N,{...t,animationStyles:x}):w(v,{children:n.Children.map(b,((c,y)=>{if(!(0,n.isValidElement)(c))return null;const b=[u,x],v=i+(e?y*a*r:0);switch(c.type){case"ol":case"ul":return w(o.ms,{children:({cx:e})=>w(c.type,{...c.props,className:e(f,c.props.className),style:{...p,...c.props.style},children:w(M,{...t,children:c.props.children})})});case"li":return w(m,{threshold:s,triggerOnce:l,onChange:g,children:({inView:t,ref:e})=>w(o.ms,{children:({cx:r})=>w(c.type,{...c.props,ref:e,className:r(d,c.props.className),css:t?b:P,style:{...h,...c.props.style,animationDelay:v+"ms"}})})});default:return w(m,{threshold:s,triggerOnce:l,onChange:g,children:({inView:t,ref:e})=>w("div",{ref:e,className:f,css:t?b:P,style:{...p,animationDelay:v+"ms"},children:w(o.ms,{children:({cx:t})=>w(c.type,{...c.props,className:t(d,c.props.className),style:{...h,...c.props.style}})})})})}}))});var T},z=t=>{const{animationStyles:e,cascade:r=!1,damping:n=.5,delay:o=0,duration:i=1e3,fraction:a=0,triggerOnce:s=!1,css:c,className:l,style:u,children:f,onVisibilityChange:p}=t,{ref:d,inView:m}=h({triggerOnce:s,threshold:a,onChange:p});return r?w("div",{ref:d,className:l,css:[c,I],style:u,children:f.split("").map(((t,r)=>w("span",{css:m?e:P,style:{animationDelay:o+r*i*n+"ms"},children:t},r)))}):w(N,{...t,children:f})},N=t=>{const{animationStyles:e,fraction:r=0,triggerOnce:n=!1,css:o,className:i,style:a,children:s,onVisibilityChange:c}=t,{ref:l,inView:u}=h({triggerOnce:n,threshold:r,onChange:c});return w("div",{ref:l,className:i,css:u?[o,e]:P,style:a,children:s})};o.F4`
  from,
  20%,
  40%,
  60%,
...
`;var J=t=>{const{big:e=!1,direction:r,reverse:o=!1,...i}=t,a=(0,n.useMemo)((()=>function(t,e,r){switch(r){case"bottom-left":return e?H:T;case"bottom-right":return e?V:E;case"down":return t?e?Y:S:e?B:O;case"left":return t?e?X:k:e?U:C;case"right":return t?e?$:L:e?W:_;case"top-left":return e?G:F;case"top-right":return e?K:j;case"up":return t?e?q:R:e?Z:A;default:return e?D:x}}(e,o,r)),[e,r,o]);return w(M,{keyframes:a,...i})};o.F4`
  from {
